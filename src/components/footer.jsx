      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
              ...
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-base text-gray-600 hover:text-gray-900">
                        {item.name}
                      </a>
                    </li>
                  ))}
          ...
          <div className="mt-12 xl:mt-0">
            <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase">Language &amp; Currency</h3>
        ...
        <div className="border-t border-gray-300 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
