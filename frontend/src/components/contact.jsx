            ...
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full lg:w-auto">
                ...
                <div className="-mr-2 flex items-center lg:hidden">
                  <Popover.Button className="bg-stone-50 rounded-md p-2 inline-flex items-center justify-center text-stone-400 hover:bg-stone-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-teal-500">
          ...
          <Popover.Panel focus className="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top lg:hidden">
            <div className="rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div className="px-5 pt-4 flex items-center justify-between">
                ...
                <div className="-mr-2">
                  <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-stone-400 hover:bg-stone-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500">
      ...
      <main className="overflow-hidden">
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="py-3 px-4 block w-full shadow-sm text-stone-900 focus:ring-teal-500 focus:border-teal-500 border-stone-300 rounded-md"
                        />
                      </div>
                    </div>
                    <div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          name="message"
                          rows={4}
                          className="py-3 px-4 block w-full shadow-sm text-stone-900 focus:ring-teal-500 focus:border-teal-500 border border-stone-300 rounded-md"
        ...
        <section aria-labelledby="offices-heading">
          <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <h2 id="offices-heading" className="text-3xl font-extrabold text-stone-900">
              Our offices
            </h2>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold text-stone-200 tracking-wider uppercase">Solutions</h3>
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold text-stone-200 tracking-wider uppercase">Support</h3>
                  <ul role="list" className="mt-4 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold text-stone-200 tracking-wider uppercase">Company</h3>
                  <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold text-stone-200 tracking-wider uppercase">Legal</h3>
                  <ul role="list" className="mt-4 space-y-4">
